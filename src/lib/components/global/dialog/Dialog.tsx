...
function DialogHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('mt-4 flex flex-col space-y-1.5 text-center sm:text-left', className)} {...props} />
}
...
function DialogFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn('mb-4 flex flex-col-reverse sm:flex-row sm:justify-center sm:space-x-2', className)}
      {...props}
    />
  )
}
